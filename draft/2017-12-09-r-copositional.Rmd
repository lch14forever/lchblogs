...
十分感谢刘老师的厚爱，向我约稿，本身我不是很擅长写教程之类面向多数人的东西。想了想，既然那天是由于对Co-occurence网络的讨论引起的，也正是自己课题的一部分，所以就分享一下这一部分的经验吧。本文的大部分内容都来自我们之前的一篇综述文章[Li et al, 2016](http://www.sciencedirect.com/science/article/pii/S1046202315300943?via%3Dihub)。
...
下载HMP [16S数据](ftp://public-ftp.ihmpdcc.org/HMQCP/otu_table_psn_v35.txt.gz)和[元数据](ftp://public-ftp.ihmpdcc.org/HMQCP/v35_map_uniquebyPSN.txt.bz2)：
```{r}
